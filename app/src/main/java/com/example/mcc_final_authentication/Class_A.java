...
public class Class_A extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        markattendance = findViewById(R.id.classA_markattendance);
        getattreport = findViewById(R.id.classA_getattreport);
        timetable = findViewById(R.id.classA_timetable);
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.exists()) {
                    currentaccounttype = dataSnapshot.child("accounttype").getValue().toString();
                        ...
                        Toast.makeText(Class_A.this, "Error Retrieving data!!", Toast.LENGTH_SHORT).show();
